...
<script type="text/javascript"
	src="https://openapi.map.naver.com/openapi/v3/maps.js?ncpClientId=v2i8uahecc"></script>
...
">
					...
					<li><a href="#"> <span style="font-size: 20px;">&nbsp;<b>/
									<%=request.getParameter("home")%></b></span>
					</a></li>
				</ol>
				...
				<div>
					...
					<table id="wow">
						...
						%>
						<tr>
							<td align="right" bgcolor="#E9ECEF"><button type="button"
									class="btn btn-#E9ECEF" value="<%=urlname%>">글쓰기</button></td>
						</tr>
					</table>
				</div>
				...
				<!-- <table class="table table-striped">
					<tr>
						<td align="left" bgcolor="#58FA58"><a href="writeForm.jsp?">글쓰기</a></td>
					</tr>
				</table> -->
				...
				<table class="table table-hover">
					...
					<%
						for (int i = 0; i < articleList.size(); i++) {
								RealEstateDataBean article = articleList.get(i);
					%>
					<tr height="30">
 ...
 %>
				...
				%>
				<a
					href="real_estate.jsp?home=<%=request.getParameter("home")%>pageNum=<%=startPage - 10%>">[이전]</a>
				<%
					}
				%>
				...
				<table width="100%">
					<tr>
						<td align="center">
							...
							%> <a
							href="real_estate.jsp?real_estate=<%=request.getParameter("real_estate")%>&home=<%=request.getParameter("home")%>&pageNum=<%=i%>">
 		...
 		if (endPage < pageCount) {
 %> <a
							href="real_estate.jsp?home=<%=request.getParameter("home")%>&pageNum=<%=startPage + 10%>">[다음]</a>
							<%
								}
								}
							%>

							</div> <!-- /.container-fluid --> <!-- Sticky Footer --> <footer
								class="sticky-footer">
							...
							</div> <!-- /#wrapper --> <!-- Scroll to Top Button--> <a
									...
									$("button")
											.click(
													function() {
														...
														location.href = "writeForm_real_estate.jsp?"
																+ fired_button2;
