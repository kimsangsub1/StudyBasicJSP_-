...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<div id="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<!-- Page Content -->
				<div style="text-align:center"><b> 판매목록(전체 목록:<%=count%>)
				</b></div>
				<table >
					<tr>
					<td align="right" bgcolor="#E9ECEF" class="list"><a
							href="#"><button type="button"
									class="btn btn-#E9ECEF">전체</button></a></td>
						<td align="right" bgcolor="#E9ECEF" class="list"><a
							href="writeForm_IDT_marketplace.jsp"><button type="button"
									class="btn btn-#E9ECEF">팝니다</button></a></td>
						<td align="right" bgcolor="#E9ECEF" class="list"><a
							href="writeForm_IDT_marketplace2.jsp"><button type="button"
									class="btn btn-#E9ECEF">삽니다</button></a></td>
					</tr>
				</table>
				...
				<table class="table table-hover">
					...
					<%
						for (int i = 0; i < articleList.size(); i++) {
							IDTMarketplaceDataBean article = articleList.get(i);
					%>
					<tr height="30">
 ...
 %> <a
							href="content_IDT_marketplace.jsp?num=<%=article.getNum()%>&pageNum=<%=currentPage%>">
 ...
 %>
				...
				<%
					if (count > 0) {
						...
						if (startPage > 10) {
				%>
				<a href="IDT_marketplace.jsp?pageNum=<%=startPage - 10%>">[이전]</a>
				<%
					}%>
				...
				<table width="100%">
					<tr>
						<td align="center">
							...
							%> <a href="IDT_marketplace.jsp?pageNum=<%=i%>">
						...
						if (endPage < pageCount) {
				%>
				<a href="IDT_marketplace.jsp?pageNum=<%=startPage + 10%>">[다음]</a>
				<%
					}
					}
				%>
