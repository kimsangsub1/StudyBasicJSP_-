...
String title = "";
      if(request.getParameter("num")==null){ 
    	...
    	<!-- Breadcrumbs-->
				<ol class="breadcrumb">
					...
					<li ><a href= "#">
					<span style="font-size:20px;">&nbsp;<b>/ <%=title%></b></span></a></li>
    ...
    <ol class="breadcrumb">
					...
					<li ><a href= "praise.jsp">
					<span style="font-size:20px;">&nbsp;<b>/ 칭찬합시다</b></span></a></li>
					<li ><a href= "content_praise.jsp?num=<%=Integer.parseInt(request.getParameter("num"))%>&pageNum=<%=pageNum%>">
				...
				<form method="post" name="writeform" action="writePro_praise.jsp"
							...
							<td colspan=2>
								<div id="nuu">
									...
									<input type="button" class="btn btn-secondary" value="목록보기"
										OnClick="window.location='praise.jsp'">
								</div>
							</td>
						</tr>
					</table>
