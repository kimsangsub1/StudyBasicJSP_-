...
<!-- Page Content -->
				...
				<%
					...
					try {
						...
						PraiseDataBean article = dbPro.getArticle(num);
...
<script type="text/javascript">
	...
	if(val1==val2){
		...
		document.location.href='deletePro_praise_admin.jsp?pageNum='+<%=pageNum%>+
				'&num='+<%=num%>;
				
				alert("관리자권한("+ val1 +") 삭제");
	}else{
		document.location.href='deleteForm_praise.jsp?num='+<%=article.getNum()%>+'&pageNum='+<%=pageNum%>;
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<ol class="breadcrumb">
					...
					<li ><a href= "praise.jsp">
					<span style="font-size:20px;">&nbsp;<b>/ 칭찬합시다</b></span></a></li>
					<li ><a href= "#">
					...
					<table >
						...
						<tr height="30">
							<td colspan="4" bgcolor="#E9ECEF" align="right"><input
								...
								onclick="document.location.href='updateForm_praise.jsp?num=<%=article.getNum()%>&pageNum=<%=pageNum%>'">
								&nbsp;&nbsp;&nbsp;&nbsp; 
								...
								onclick="document.location.href='writeForm_praise.jsp?num=<%=num%>&ref=<%=ref%>&re_step=<%=re_step%>&re_level=<%=re_level%>'">
								&nbsp;&nbsp;&nbsp;&nbsp; <input type="button"class="btn btn-secondary"  value="글목록"
								onclick="document.location.href='praise.jsp?pageNum=<%=pageNum%>'">
							</td>
						</tr>
					</table>
					<%
