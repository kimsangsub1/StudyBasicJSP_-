   ...
   <!-- Navbar Search -->
	...
	%>
				...
				<ol class="breadcrumb">
					...
					<li><a href="#"> <span
							style="font-size: 20px;">&nbsp;<b>/ 글쓰기</b></span></a></li>
				</ol>
...
%>
				...
				<form method="post" name="writeform" action="writePro_concern_counseling.jsp?theme=<%=theme %>"
					...
					<table style = "width:100px; margin-left: auto; margin-right: auto;">
						...
						<tr>
							...
							maxlength="10" name = "writer" style="width:400px ;ime-mode: active;"/>
							<!--active:한글-->
						</tr>
						<tr>
							...
							<td colspan=2>
								<div id="nuu">
									...
									<input type="button" class="btn btn-secondary" value="목록보기"
										OnClick="window.location='concern_counseling.jsp?theme=<%=theme%>'"></td>
								</div>
							</td>
						</tr>
					</table>
