...
">
				...
				<%
					...
					try {
						...
						RealEstateDataBean article = dbPro.updateGetArticle(num);
				%>
				...
				<form method="post" name="writeform"
					action="updatePro_real_estate.jsp?real_estate=<%=request.getParameter("real_estate")%>
&home=<%=request.getParameter("home")%>
&num=<%=request.getParameter("num")%>
&pageNum=<%=request.getParameter("pageNum")%>"
					...
					<table style="width: 100px;">
						<tr>
							<td width="100" bgcolor="#E9ECEF" align="center" class="list">이
								름</td>
						...
						<tr>
							<td width="100" bgcolor="#E9ECEF" align="center" class="list">제
								목</td>
						...
						<tr>
							<td width="100" bgcolor="#E9ECEF" align="center" class="list">내
								용</td>
						...
						<tr>
							<td width="110" bgcolor="#E9ECEF" align="center" class="list">비밀번호</td>
							<td align="left" width="500"><input type="password" size="8"
							...
							<td colspan=2 align="center" id="nuup">
								<div id="nuu">
									...
									<input type="button" class="btn btn-secondary" value="목록보기" 
										onclick="document.location.href='real_estate.jsp?real_estate=<%=request.getParameter("real_estate")%>&home=<%=request.getParameter("home")%>&num=<%=request.getParameter("num")%>&pageNum=<%=request.getParameter("pageNum")%>'">
								</div>
							</td>
						</tr>
