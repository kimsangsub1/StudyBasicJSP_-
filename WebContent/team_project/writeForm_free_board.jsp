...
String title = "";
    ...
    <ol class="breadcrumb">
					...
					<li ><a href= "free_board.jsp">
					<span style="font-size:20px;">&nbsp;<b>/ 와글와글 잡담방</b></span></a></li>
					<li ><a href= "content_free_board.jsp?num=<%=Integer.parseInt(request.getParameter("num"))%>&pageNum=<%=pageNum%>">
...
%>
				...
				<form method="post" name="writeform" action="writePro_free_board.jsp"
							...
							<td colspan=2>
								<div id="nuu">
									...
									<input type="button" class="btn btn-secondary" value="목록보기"
										OnClick="window.location='free_board.jsp'">
								</div>
							</td>
						</tr>
					</table>
