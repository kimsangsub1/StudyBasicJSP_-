...
var marker1 = new naver.maps.Marker({
    position: new naver.maps.LatLng(37.554994, 126.925240),
...
iwContent1 = [
    '<div style="border:0;background: #8160E2;">',
        ...
        '<a href="https://new.land.naver.com/complexes/101790?ms=37.557695,126.922934,11&a=APT:ABYG:JGC:OPST&b=A1:B1:B2:B3&e=RETAIL" title="누르시면 사이트로 이동합니다."><img src = "images/home6.png"></a>',
            '<br><a href = "real_estate.jsp?real_estate=hongdae&home=kwangnm" title="누르시면 게시판으로 이동합니다."><span style = "color:#ffffff"><i class="fas fa-bed"></i>광남벨라스</span></a>',
            '<div style="color:#ffffff;">전세5.5억</div><br><br>',
        '</div>',
    '</div>'
].join(''),
...
var marker2 = new naver.maps.Marker({
    position: new naver.maps.LatLng(37.559226, 126.927053),
...
iwContent2 = [
    ...
    '<img src ="images/home2.png">',
        '<br><a href = "real_estate.jsp?home=threeR"><span style = "color:#ffffff"><i class="fas fa-bed"></i>쓰리알유시티</span></a>',
        '<div style="color:#ffffff;">월세40만~75만</div><br><br>',
    '</div>',
'</div>'
].join(''),
...
var marker3 = new naver.maps.Marker({
    position: new naver.maps.LatLng(37.558605, 126.923749),
...
iwContent3 = [
    ...
    '<img src ="images/home3.png">',
        '<br><a href = "real_estate.jsp?home=lovehi"><span style = "color:#ffffff"><i class="fas fa-bed"></i>홍익사랑</span></a>',
        '<div style="color:#ffffff;">월세55만~1백</div><br><br>',
    '</div>',
'</div>'
].join(''),
...
var marker4 = new naver.maps.Marker({
    position: new naver.maps.LatLng(37.563253, 126.925315),
...
iwContent4 = [
    ...
    '<img src = "images/home4.png">',
        '<br><span style = "color:#ffffff"><i class="fas fa-bed"></i>태영</span>',
        '<div style="color:#ffffff;">월세50만~1.6백</div><br><br>',
    '</div>',
'</div>'
].join(''),
...
var marker5 = new naver.maps.Marker({
    position: new naver.maps.LatLng(37.564180, 126.922193),
...
iwContent5 = [
	'<div style="border:0;background: #8160E2;">',
    '<div style="margin:0;padding:5px; background: #8160E2;border-radius: 10%;width:250px;" class="clickable" >',
        '<br><span style = "color:#ffffff"><i class="fas fa-bed"></i>청전현대타운</span>',
        '<div style="color:#ffffff;">전세5.2억</div><br><br>',
    '</div>',
'</div>'
].join(''),
...
var marker6 = new naver.maps.Marker({
    position: new naver.maps.LatLng(37.556009, 126.933115),
...
var marker7 = new naver.maps.Marker({
    position: new naver.maps.LatLng(37.553934, 126.926262),
...
iwContent7 = [
    ...
    '<img src ="images/home5.png">',
        '<br><span style = "color:#ffffff"><i class="fas fa-bed"></i>한숲마을</span>',
...
var marker8 = new naver.maps.Marker({
    position: new naver.maps.LatLng(37.553969, 126.929340),
...
var marker9 = new naver.maps.Marker({
    position: new naver.maps.LatLng(37.569485, 126.921273),
...
iwContent9 = [
	'<div style="border:0;background: #8160E2;">',
    '<div style="margin:0;padding:5px; background: #8160E2;border-radius: 10%;width:250px;" class="clickable" >',
        '<br><span style = "color:#ffffff"><i class="fas fa-bed"></i>다곡아파트</span>',
...
var marker10 = new naver.maps.Marker({
    position: new naver.maps.LatLng(37.570337, 126.924478),
...
iwContent10 = [
	...
	'<div style="border:0;background: #8160E2;">',
    '<div style="margin:0;padding:5px; background: #8160E2;border-radius: 10%;width:250px;" class="clickable" >',
        '<br><span style = "color:#ffffff"><i class="fas fa-bed"></i><b>홍대샤르망</b></span>',
...
var marker16 = new naver.maps.Marker({
    position: new naver.maps.LatLng(37.564917, 126.920712),
...
var marker11 = new naver.maps.Marker({
    position: new naver.maps.LatLng(37.569237, 126.927466),
...
iwContent11 = [
	'<div style="border:0;background: #8160E2;">',
    '<div style="margin:0;padding:5px; background: #8160E2;border-radius: 10%;width:250px;" class="clickable" >',
        '<br><span style = "color:#ffffff"><i class="fas fa-bed"></i><b>힐스테이트홍대점</b></span>',
...
var marker12 = new naver.maps.Marker({
    position: new naver.maps.LatLng(37.560780, 126.932247),
...
iwContent12 = [
	'<div style="border:0;background: #8160E2;">',
    '<div style="margin:0;padding:5px; background: #8160E2;border-radius: 10%;width:250px;" class="clickable" >',
        '<br><span style = "color:#ffffff"><i class="fas fa-bed"></i><b>타워팰리스</b></span>',
...
var marker13 = new naver.maps.Marker({
    position: new naver.maps.LatLng(37.552015, 126.935937),
...
var marker14 = new naver.maps.Marker({
    position: new naver.maps.LatLng(37.553778, 126.923664),
...
iwContent14 = [
    '<div style="border:0;background: #8160E2;">',
        '<div style="margin:0;padding:5px; background: #8160E2;border-radius: 10%;width:250px;" class="clickable" >',
            '<div style= "color:#ffffff;"><i class="fas fa-bed"></i>홍대샤르망2</a>',
...
var marker15 = new naver.maps.Marker({
    position: new naver.maps.LatLng(37.559765, 126.926787),
...
var marker16 = new naver.maps.Marker({
    position: new naver.maps.LatLng(37.550620, 126.937860),
