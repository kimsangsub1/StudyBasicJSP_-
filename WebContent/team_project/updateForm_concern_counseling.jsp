...
<body>
   ...
   <!-- Navbar Search -->
	...
	%>
				...
				<ol class="breadcrumb">
					...
					<li><a href="content_concern_counseling.jsp?theme=<%=theme%>&num=<%=num%>&pageNum=<%=pageNum%>"> <span
							style="font-size: 20px;">&nbsp;<b>/ 글내용 보기</b></span></a></li>
					<li><a href="#"> <span
							style="font-size: 20px;">&nbsp;<b>/ 글수정</b></span></a></li>
				</ol>
  ...
  try{
	  ...
	  ConcernCounselingDataBean article =  dbPro.updateGetArticle(num);
...
%>
				...
				<form method="post" name="writeform"
					action="updatePro_concern_counseling.jsp?theme=<%=theme %>&pageNum=<%=pageNum%>"
