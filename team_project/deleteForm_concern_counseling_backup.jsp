...
<body>
	...
	<div id="wrapper">
		...
		<ul class="sidebar navbar-nav">
			...
			<li class="nav-item"><a class="nav-link"
				href="IDT_market.jsp"> <span>IDT 장터</span>
			</a></li>
		</ul>
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<form method="POST" name="delForm"
					action="deletePro_concern_counseling.jsp?pageNum=<%=pageNum%>"
					...
					<table>
						...
						<tr height="30">
							<td align=center bgcolor="<%=value_c%>"><input type="submit"
								...
								onclick="document.location.href='concern_counseling.jsp?pageNum=<%=pageNum%>'">
							</td>
						</tr>
					</table>
				</form>
