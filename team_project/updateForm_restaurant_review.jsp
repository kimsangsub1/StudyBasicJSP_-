...
<body>
		...
		<div id="content-wrapper">
			...
			%>
				...
				<ol class="breadcrumb">
					...
					<li ><a href= "content_restaurant_review.jsp?food=<%=food %>&num=<%=num%>&pageNum=<%=pageNum%>">
  ...
  try{
	  ...
	  RestaurantReviewDataBean article =  dbPro.updateGetArticle(num);
...
%>
				...
				<form method="post" name="writeform"
					action="updatePro_restaurant_review.jsp?pageNum=<%=pageNum%>&food=<%=request.getParameter("food") %>"
					...
					<table style = "width:100px;">
						...
						<tr>
							...
							onclick="document.location.href='restaurant_review.jsp?food=<%=food%>'">
								</div>
							</td>
						</tr>
