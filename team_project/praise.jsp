		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<table>
					...
					<tr>
						<td align="right" bgcolor="#E9ECEF">
						
						<td align="right" bgcolor="#E9ECEF" id="nuu">
						<a href="writeForm_praise.jsp"><button type="button" class="btn btn-#E9ECEF">글쓰기</button></a></td>
					...
					<tr height="30">
						...
						<div class="card">
							<div class="cardheader">
								<div id = "chd">
								<h5 class="mt-0 ">
									<img src="images/ryan.png"> #<%=number--%>번째 칭찬의 소리
								</h5>
								</div>
							...
							<div class="card-body">
								<h5 class="card-title">
									...
									<%=article.getSubject()%><br>

								</h5>
								<pre class="card-text"><%=article.getContent()%></pre>
								...
								%>
								<img src="images/hot.png" border="0" height="16"><br>
								<%
									}
								%>

								작성일 : <%=sdf.format(article.getReg_date())%><br>
								조회 : <%=article.getReadcount()%><br>

								IP : <%=article.getIp()%><br> <a
									href="content_praise.jsp?num=<%=article.getNum()%>&pageNum=<%=currentPage%>"
									class="btn btn-primary" id="btn2">More</a>
				...
				<%
					if (count > 0) {
						...
						if (startPage > 10) {
				%>
				<a href="praise.jsp?pageNum=<%=startPage - 10%>">[이전]</a>
				<%
					}%>
