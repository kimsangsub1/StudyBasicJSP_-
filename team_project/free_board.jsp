...
<body id="page-top">
			...
			<div class="container-fluid">
				...
				<table>
					<tr>
						...
						<a href="writeForm_free_board.jsp" ><button type="button" class="btn btn-#E9ECEF">글쓰기</button></a></td>
					</tr>
				</table>
		...
		<table class="table table-hover">
					...
					<%
						for (int i = 0; i < articleList.size(); i++) {
								FreeBoardDataBean article = articleList.get(i);
					%>
					<tr height="30">
 ...
 %> <a
							href="content_free_board.jsp?num=<%=article.getNum()%>&pageNum=<%=currentPage%>">
 ...
 %>
				...
				if (count > 0) {
					...
					if (startPage > 10) {
			%>
			<a href="free_board.jsp?pageNum=<%=startPage - 10%>">[이전]</a>
			<%
				}%>
			...
			<table width="100%">
				<tr>
					<td align="center">
						...
						%> <a href="free_board.jsp?pageNum=<%=i%>">
