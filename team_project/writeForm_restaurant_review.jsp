   ...
   <!-- Navbar Search -->
	...
	<div id="wrapper">
		...
		<div id="content-wrapper">
			...
			<%
			String mainnm = "";
			if(request.getParameter("food").equals("Baren")||request.getParameter("food").equals("Allback")){
			...
			%>
				...
				<ol class="breadcrumb">
					...
					<li ><a href= "main_restaurant_review2.jsp?<%=mainnm%>">
					<span style="font-size:20px;">&nbsp;<b>/ 맛집리뷰</b></span></a></li>
					<li ><a href= "restaurant_review.jsp?food=<%=request.getParameter("food")%>">
					<span style="font-size:20px;">&nbsp;<b>/ 리뷰게시판</b></span></a></li>
					<li ><a href= #>
					<span style="font-size:20px;">&nbsp;<b>/ 글쓰기</b></span></a></li>
				</ol>
				
				<% 	}else if(request.getParameter("food").equals("gaes")||request.getParameter("food").equals("ddowat")||request.getParameter("food").equals("duckfm")){
				...
				<ol class="breadcrumb">
					...
					<li ><a href= "home_restaurant_review.jsp">
					<span style="font-size:20px;">&nbsp;<b>/ 맛집탐방</b></span></a></li>
					<li ><a href= "main_restaurant_review.jsp?<%=mainnm%>">
					<span style="font-size:20px;">&nbsp;<b>/ 맛집리뷰</b></span></a></li>
					<li ><a href= "restaurant_review.jsp?food=<%=request.getParameter("food")%>">
					<span style="font-size:20px;">&nbsp;<b>/ 리뷰게시판</b></span></a></li>
					<li ><a href= #>
...
%>
				<div style="text-align:center"><p><b>글쓰기</b></p></div>
				<form method="post" name="writeform" action="writePro_restaurant_review.jsp?food=<%=request.getParameter("food") %>"
					onsubmit="return writeSave()" value="">
					...
					<table style = "width:100px; margin-left: auto; margin-right: auto;">
						...
						<tr>
							<td width="130" bgcolor="#E9ECEF" align="center" class="line">[가게]이 름</td>
							<td width="500" align="left"><input type="text" id="cInput" size="10" 
							maxlength="10" name = "writer" style="width:400px ;ime-mode: active;"/>  <input type="button" value="가져오기" class ="btn btn-secondary btn-sm" onclick="getParentText()"/>
								</td>
							<!--active:한글-->
						</tr>
						<tr>
							<td width="100" bgcolor="#E9ECEF" align="center">제 목</td>
...
%> 								<input type="text" size="40" maxlength="50" name="subject"
						...
						<tr>
							<td width="100" bgcolor="#E9ECEF" align="center">Email</td>
						...
						<tr>
							...
							<input type="submit" value="글쓰기" class="btn btn-secondary">&nbsp;&nbsp;
								...
								OnClick="window.location='restaurant_review.jsp?food=Baren'">
								</div>
							</td>
						</tr>
					</table>
...
%>
  ...
  String urlname ="";
				...
				urlname = request.getParameter("food"); %> 
	<script>
	function getParentText(){
		
		var tt= "<%=urlname %>";
		 document.getElementById("cInput").value = "[" + tt + "]";
