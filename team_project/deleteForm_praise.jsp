		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<ol class="breadcrumb">
					...
					<li><a href="praise.jsp"> <span style="font-size: 20px;">&nbsp;<b>/
									칭찬합시다</b></span></a></li>
					<li><a href="content_praise.jsp?num=<%=num%>&pageNum<%=pageNum%>"> <span style="font-size: 20px;">&nbsp;<b>/
									글내용 보기</b></span></a></li>
					<li><a href="#"> <span
				...
				<form method="POST" name="delForm"
					action="deletePro_praise.jsp?pageNum=<%=pageNum%>"
